...
public:
	...
	void SetAbsAngles2(Vector angle)
	{
		using SetAbsAnglesFn = void(__thiscall*)(void*, const Vector& angle);
		static SetAbsAnglesFn SetAbsAngles;

		if (!SetAbsAngles)
			SetAbsAngles = (SetAbsAnglesFn)(Utils::PatternScan(GetModuleHandleW(L"client.dll"), "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8"));
	...
	bool&	       UpdateClientSideAnimation();
