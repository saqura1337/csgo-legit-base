...
extern ImFont* SegoeUI_32px;
extern ImFont* SegoeUI_8px;
extern ImFont* g_pDefaultFont;
extern ImFont* g_VeloFont;
extern ImFont* g_SpectatorListFont;
extern ImFont* lucidaconsole;
extern ImFont* g_Calibri;
extern ImFont* g_pWeaponsFont;
...
public:
	...
	float RenderText(const std::string& text, ImVec2 position, float size, Color color, bool center = false, bool outline = true, ImFont* pFont = g_pDefaultFont, bool dropshadow = false);
	...
	template <class T>
	inline float RenderText(const std::string& text, T x, T y, float size, Color clr, bool center = false, bool outline = true, ImFont* pFont = g_pDefaultFont, bool dropshadow = false) {
		return RenderText(text, ImVec2(x, y), size, clr, center, outline, pFont, dropshadow);
	}
	template <class T>
